...
import "./canvas.js";
import { prizeData, users } from './prizeData.js';
import {
  addQipao,
  setPrizes,
  showPrizeList,
...
function lottery() {
  ...
  rotateBall().then(() => {
    ...
    for (let i = 0; i < perCount; i++) {
      ...
      const [id,name] = basicData.leftUsers[luckyId];
      console.log(name);
      
      if ((name == '宋玉玲' && currentPrize.title !== '红米平板10.6英寸2K屏')||(currentPrize.title == '红米平板10.6英寸2K屏' && name != '宋玉玲')){
        i--;
        continue;
      }
      if ((name == '刘秀兰' && currentPrize.title !== '天猫精灵智慧屏')||(currentPrize.title == '天猫精灵智慧屏' && name != '刘秀兰')){
        i--;
        continue;
      }
      if ((name == '张芮涵' && currentPrize.title !== '八音盒旋转木马') || (currentPrize.title == '八音盒旋转木马' && name != '张芮涵')){
        i--;
        continue;
      }
      if ((name == '张诗雨' && currentPrize.title !== '叶罗丽娃娃') || (currentPrize.title == '叶罗丽娃娃' && name != '张诗雨')){
        i--;
        continue;
      }
